...
public class ClassRosterDaoFileImplTest {
    ...
    public void testRemoveStudent() throws Exception {
        ...
        // Then the specifics
        assertFalse(allStudents.contains(firstStudent), "All students should NOT have Ada.");
        assertTrue(allStudents.contains(secondStudent), "All students should have Charles");
